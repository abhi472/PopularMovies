...
public class DetailActivity_ViewBinding<T extends DetailActivity> implements Unbinder {
  ...
  public DetailActivity_ViewBinding(T target, Finder finder, Object source) {
    ...
    target.play = finder.findRequiredViewAsType(source, R.id.play, "field 'play'", ImageView.class);
    target.scrim = finder.findRequiredViewAsType(source, R.id.scrim, "field 'scrim'", ImageView.class);
    target.thumb = finder.findRequiredViewAsType(source, R.id.thumb, "field 'thumb'", ImageView.class);
    target.back = finder.findRequiredViewAsType(source, R.id.image, "field 'back'", ImageView.class);
    target.app = finder.findRequiredViewAsType(source, R.id.app_bar_layout, "field 'app'", AppBarLayout.class);
    ...
    target.pback = finder.findRequiredViewAsType(source, R.id.progressBar, "field 'pback'", ProgressBar.class);
